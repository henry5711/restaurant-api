	...
	<main class="full-box main-container">
				...
				<nav class="full-box nav-lateral-menu">
					<ul>
						...
						<li>
							...
							<ul>
								<li><a href="rol_index.html"><i class="fas fa-user-plus fa-fw"></i> &nbsp; Nuevo admin</a></li>
								<li><a href="rol_index.html"><i class="fas fa-users fa-fw"></i> &nbsp; Listar admin</a></li>
							</ul>
						</li>
						...
						<li>
							...
							<ul>
								<li><a href="product_store.html"><i class="fas fa-box fa-fw"></i> &nbsp; Nuevo producto</a></li>
								<li><a href="product_index.html"><i class="fas fa-boxes fa-fw"></i> &nbsp; Listar productos</a></li>
							</ul>
						</li>
		...
		<section class="full-box page-content">
			...
			<div class="full-box tile-container">
				...
				<a href="rol_index.html" class="tile">
					<div class="tile-tittle">Listar admins</div>
					<div class="tile-icon">
				...
				<a href="product_index.html" class="tile">
					<div class="tile-tittle">Listar productos</div>
					<div class="tile-icon">
				...
				<a href="user_index.html" class="tile">
					<div class="tile-tittle">Listar clientes</div>
					<div class="tile-icon">
